...
class knot (
  ...
  Hash                             $files                = {},
  Hash                             $remotes              = {},
  Array[Stdlib::IP::Address]       $ip_addresses         = $::knot::params::ip_addresses,
  ...
  Stdlib::Unixpath                 $pidfile              = $::knot::params::pidfile,
  Stdlib::Port                     $port                 = 53,
  String                           $username             = 'knot',
  Stdlib::Unixpath                 $zonesdir             = $::knot::params::zonesdir,
  Stdlib::Unixpath                 $kzonecheck_bin       = $::knot::params::kzonecheck_bin,
  ...
  Stdlib::Unixpath                 $conf_dir             = $::knot::params::conf_dir,
  Stdlib::Unixpath                 $zone_subdir          = $::knot::params::zone_subdir,
  Stdlib::Unixpath                 $conf_file            = $::knot::params::conf_file,
  Stdlib::Unixpath                 $run_dir              = $::knot::params::run_dir,
